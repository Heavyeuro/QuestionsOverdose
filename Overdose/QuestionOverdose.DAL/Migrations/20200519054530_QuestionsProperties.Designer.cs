...
namespace QuestionOverdose.DAL.Migrations
{
    ...
    [Migration("20200519054530_QuestionsProperties")]
    partial class QuestionsProperties
    {
            ...
            modelBuilder.Entity("QuestionOverdose.Domain.Entities.Tag", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateOfCreation = new DateTime(2020, 5, 19, 8, 45, 30, 13, DateTimeKind.Local).AddTicks(9679),
                            TagName = ".Net"
                        },
                        new
                        {
                            Id = 2,
                            DateOfCreation = new DateTime(2020, 5, 19, 8, 45, 30, 14, DateTimeKind.Local).AddTicks(1062),
                            TagName = "Angular"
                        });
                });
