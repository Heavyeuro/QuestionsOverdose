        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommentAncestorId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Comments_Comments_CommentAncestorId",
                        column: x => x.CommentAncestorId,
            ...
            migrationBuilder.InsertData(
                table: "Role",
                columns: new[] { "Id", "RoleName" },
                values: new object[] { 3, "Redactor" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Email", "FullName", "Password", "UserRoleId", "Username" },
                values: new object[] { 1, "Admin", null, "Admin", 2, "Admin" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Email", "FullName", "Password", "UserRoleId", "Username" },
                values: new object[] { 2, "Redactor", null, "Redactor", 3, "Redactor" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_CommentAncestorId",
                table: "Comments",
                column: "CommentAncestorId");
